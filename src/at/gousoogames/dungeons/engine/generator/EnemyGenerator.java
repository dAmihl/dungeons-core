...
import at.gousoogames.dungeons.engine.character.npc.enemies.Goblin;
import at.gousoogames.dungeons.engine.character.npc.enemies.HumanoidEnemy;
import at.gousoogames.dungeons.engine.character.npc.enemies.Skeleton;
import at.gousoogames.dungeons.engine.character.npc.enemies.Spider;
...
//		Skill s1 = SkillFactory.getNewPhysicalNormalAttack();
		...
		s1.setCharacter(e);
		s1.addExp(at.gousoogames.dungeons.game.game.Game.getGameManager().getEnvironmentLevel() * 1000);//TODO
		e.learnSkill(s1);
//		e.learnSkill(s2);
	}
