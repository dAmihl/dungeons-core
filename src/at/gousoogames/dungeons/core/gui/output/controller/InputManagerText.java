...
public class InputManagerText implements IInputManager {
	...
	public void handleInputSkillset(InputContainer c) {
		...
		if (input > p.getSkillset().getLearnedSkills().size()) OutputFactory.getOutput().drawRoom(at.gousoogames.dungeons.core.game.game.Game.getGameManager().getDungeonManager().getCurrentRoom());
