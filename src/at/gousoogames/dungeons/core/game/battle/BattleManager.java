package at.gousoogames.dungeons.core.game.battle;

import at.gousoogames.dungeons.core.engine.ai.AI;
...
public class BattleManager {
	...
	private void nextRound(){
		enemiesTickBuffs();
		at.gousoogames.dungeons.core.game.game.Game.getGameManager().nextRound();
		switch (roundCount % 2){
...
//		Debug.log("Life of ENemy now: "+e.getStats().getCurrentHealthPoints());
	...
	private void battleOver(BattleTeam winnerTeam){
		...
		for (GameCharacter c : teamTwo.getMembers()){
			at.gousoogames.dungeons.core.game.game.Game.getGameManager().getPlayers()[0].lootInventory(c.getInventory());
		}
		at.gousoogames.dungeons.core.game.game.Game.getGameManager().nextRoom();
	}
