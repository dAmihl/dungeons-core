...
public class LargeRoomScreen extends AbstractRoomScreen {

	public LargeRoomScreen(Game gameApplication, Room room) {
	...
	public void render(float delta) {
		...
		String text = "oh hello to my laaaaarge room. here ya got \n";
